...
// Fija el juego FH2 para tabs/ranking/clanes.
...
render_header('Forgotten Hope 2', [
    ...
    'hero_subtitle' => 'Forgotten Hope 2 Stats',
    'toolbar_title' => 'Forgotten Hope 2 - estadisticas LATAMSQUAD',
]);
?>
        <section class="seo-intro" aria-label="Forgotten Hope 2 - estadisticas LATAMSQUAD">
                        <p class="seo-intro__text">
                Resumen del servidor elegido: totales de jugadores, score, kills y última sincronización,
                más el top player y el top clan. Desde aquí podés ir al ranking completo, a los rangos
