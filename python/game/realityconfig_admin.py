...
ann_joinMessage = "§C1001Bienvenido a LATAMSQUAD!"
#
...
ann_timedMessages = {
    ...
    320:  "Usa !stats para saber tu posicion en el ranking, K/D y mas!",
    350:  "Durante el briefing usa !switch para cambiarte de equipo, sin necesidad de molestar a un administrador.",
    ...
    350:  "La clave del servidor 2 es latamlife",
    450:  "Recuerda ver tus estadisticas/rango en la web stats.latamsquad.org",
    600:  "Encuentra el tesoro del mapa! Consulta !tesoro",
   1200:  "Provocar al equipo contrario por all chat es motivo de roundban.",
   1000:  "Puedes cambiar de idioma con el comando !lang",
}
#
#
# ==============================================================================
...
adm_autoAdmin = True
#
# Kick automatico por teamkills (sistema Python propio, independiente de !aa).
# El kick vanilla de BF2 (sv.tkPunishEnabled / sv.tkNumPunishToKick) no es fiable en PR.
# Se controla con !ak on|off (no usa el cvar del motor).
# Default is True (arranca activado al cargar el mod)
adm_autoTkKick = True
#
# Cantidad de teamkills (por jugador) para autokick.
# Default is 3
adm_autoTkKickLimit = 3
#
# Ventana en segundos: cada este tiempo se resta 1 TK del contador (no borra todos).
# Default is 300 (5 minutos)
adm_autoTkKickExpireSec = 300
#
...
#
# The maximum distance a player can be pushed.
# Default is 10
adm_maxPush = 10000
#
...
adm_adminHashes = {
    "0161096bb0984d11bccc7f6f776e2e82":    1,    # _JORGE           --Administrador
    ...
    "6e707951874e4f3ba8fe3a398ff580c4":    1,    # MathySJ_ArG      --Administrador
    "6da8d35fd158481e8f0e8e7195781c06":    1,    # Mizzar           --Administrador 
    "97918d9fd1d74a93b0dddb132c570264":    0,    # NascimentoWAR    --Supervisor
    "5106ccbe505548d1b446c358cdd9b5d9":    1,    # NotGenius        --Administrador
    "bf62777a89d6499ea0badf2284839cc6":    1,    # Ricardo          --Administrador 
    "025a490b9cfe4b028a92f4aec5899037":    0,    # Sunfiree         --Supervisor
    "566f70f624fe407784ddd394319b9473":    1,    # TheCreazy911     --Administrador
    "501eb007fef44c8ead5c951c03740991":    0,    # Tosky2712        --Supervisor   
    "bc0b80c909d24bfd97008d196b1be294":    0,    # Zxrro            --Directivo
    "5e2e514f66554776b4a8b2ff7c2186d6":    1,    # SwatiusPilot     --Administrador
}
#
...
adm_adminPowerLevels = {
    ...
    # Similar to !warn but without the DEJA DE HACER ESO! and is private.
    "message": 2,
    #
    ...
    "pilot": 0,
    #
    # Bans a player from using a specific asset
    "assetban": 2,
    #
    # Unbans a player from using a spwcific asset
    "assetunban": 0,
    #
    # Chaziz debugging stuff
    "rel": 0,
    #
    # Link code for LATAMSTATS
    "link": 777,
    #
    #
    # Rearms a player ammo
    #"rearm": 0,
    #
    # Heals a player
    #"heal": 0,
...
adm_ban_reason_suffix = "Debes apelar en discord.gg/latamsquad"
#
...
# Kick players when PRMS proxy reports an unknown hash (line kick in realityplayerdata).
# Runtime toggle: !proxy on|off (default follows this value on server start).
ec_proxyKickUnknownHash = True
...
mum_mumbleSecret = "cGW8pZYhEUa6IOrB3yi6"
...
bans_sqlite3 = "C:/prbf2_db/bans1.sqlite3"
