...
# - PRDEBUG_ALL
#
# $Id: realityconfig_local.py 43831 2026-03-12 16:35:00Z prbot $
#
#
...
C['KIT_LIMIT_8'] = { 'sniper':     1, 'aa': 1, 'at': 1, 'engineer': 1, 'marksman': 1, 'assault': 1, 'riflemanat': 1,
...
C['KIT_SUPPLY_OBJECTS'] = {
    ...
    'saf':          { 'pr_supply_crate_saf':    CONSTANTS.DISTANCE_PICKUP, 'light_supply_crate_saf': CONSTANTS.DISTANCE_PICKUP,
...
C['KIT_SUPPLY_OBJECTS_VEHICLES'] = {
    ...
    'saf':         { 'mec_apc_boragh':    CONSTANTS.DISTANCE_PICKUP, 'saf_apc_btr60': CONSTANTS.DISTANCE_PICKUP,
                     'mec_ifv_bmp3':      CONSTANTS.DISTANCE_PICKUP, 'mec_apc_mtlb': CONSTANTS.DISTANCE_PICKUP,
                     'mec_apc_mtlb_hmg':  CONSTANTS.DISTANCE_PICKUP, 'mec_apc_mtlb_30mm': CONSTANTS.DISTANCE_PICKUP,
...
C['RALLY_TEAMS'] = ['arf', 'arg82', 'cf', 'ch', 'chinsurgent', 'chinsurgent90', 'chechen90', 'fr', 'saf', 'fsa', 'gb', 'gb82', 'ger', 'hamas', 'idf', 'mec',
...
# Default is arf, ch, gb, mec, us, usa, cf, chinsurgent, chinsurgent90, ru, ru90, arf, taliban, idf, hamas, ger, vnusa, vnusmc, vnnva, gb82, arg82, fr, saf, nl, ww2ger, ww2usa
C['RALLY_TEAMS_COMMANDER'] = ['arf', 'arg82', 'cf', 'ch', 'chinsurgent', 'chinsurgent90', 'chechen90', 'fr', 'saf', 'fsa', 'gb', 'gb82', 'ger', 'hamas',
...
C['ASSET_TEAMS'] = ['ch', 'gb', 'mec', 'us', 'usa', 'fsa', 'cf', 'chinsurgent', 'chinsurgent90', 'chechen90', 'meinsurgent', 'pl', 'ru', 'ru90', 'arf', 'taliban',
                    'idf', 'hamas', 'ger', 'vnusa', 'vnusmc', 'vnnva', 'gb82', 'arg82', 'fr', 'saf', 'nl', 'ww2ger', 'ww2usa', 'ww2ger41', 'ww2rus', 'ww2rusearly']
#
#
