...
#
# $Id: realityconfig_coop.py 43831 2026-03-12 16:35:00Z prbot $
#
#
...
C['RALLY_TEAMS'] = [
    'arf', 'arg82', 'cf', 'ch', 'chinsurgent', 'chinsurgent90', 'chechen90', 'fr', 'saf','fsa', 'gb', 'gb82', 'ger', 'hamas', 'idf',
...
C['HMG_TEMPLATES'] = {
    ...
    'saf': ['deployable_50cal_tripod_kord_sp'],
...
C['MORTAR_TEMPLATES'] = {
    ...
    'saf': ['deployable_mortar_2b141_podnos_sp'],
...
C['TEAM_NAME'] = {
    ...
    "mec": "The MEC Forces",
    "saf": "The Syrian Arab Armed Forces",
...
#
C["RANDOMIZE_KITS"] = 1
# Pack A casual: menos francotiradores en bots (kits de IA).
C["SPECIFIC_EXCLUDED_KITS"] = ('sniper', 'marksman')
#
#
C["BOT_DYNAMIC_RESPAWN"] = 0
C["SPAWN_TIME_MODIFIER"] = 1.0
#
# BOT SCALE (srv3): 56 bots spawn, liberacion progresiva segun humanos (latambots_scale.py)
# Posiciones por mapa: latambots_scale_maps.json + cache auto latambots_scale_cache.json
C["BOT_SCALE_ENABLED"] = 1
# Mas bots activos con pocos humanos (antes 16/24/32/48 se sentia vacio).
C["BOT_SCALE_TIERS"] = (
    (1, 32),
    (3, 40),
    (6, 48),
...
C["BOT_SCALE_SETUP_DELAY"] = 6.0
# Re-teleport frecuente: en altura caen por gravedad si no se reinicia la posicion.
C["BOT_SCALE_ENFORCE_INTERVAL"] = 1.5
C["BOT_SCALE_HOLD_DISTANCE"] = -80.0
C["BOT_SCALE_RELEASE_DISTANCE"] = 10.0
# Hold en el cielo (Y absoluta). Enterrarlos bajo el mapa hacia que salgan volando al soltar.
C["BOT_SCALE_HOLD_Y_OFFSET"] = 0.0
C["BOT_SCALE_HOLD_ABS_Y"] = 5000.0
# Espaciado entre bots retenidos (metros) para evitar colisiones / dano a vehiculos.
C["BOT_SCALE_HOLD_SPACING"] = 8.0
C["BOT_SCALE_HOLD_COLS"] = 8
C["BOT_SCALE_RELEASE_SPACING"] = 4.0
C["BOT_SCALE_RELEASE_COLS"] = 6
# Con enforce siempre-on, el drift solo es respaldo.
C["BOT_SCALE_HOLD_MAX_DRIFT"] = 5.0
# killPlayer en bots falla ("Do not mess with bots input"); solo teleport al soltar.
C["BOT_SCALE_RELEASE_RESET_AI"] = 0
C["BOT_SCALE_RELEASE_SPAWN_DELAY"] = 2.0
#
#
